...
export default function FlavorsScreen({ navigation }) {
  ...
  const renderFlavors = () => {
    ...
    useEffect (() => {
      let records = [];
      const FlavorsRef = ref(db, 'Flavors @ Utown');
                ...
                <Pressable
                  ...
                  onPress={() => {
                    if (newRating === "") {
                      ...
                      update(ref(db, 'Flavors @ Utown/' + childKey), {number_of_ratings: noOfRatings + 1, rating: aveRatings});
